  ...
  export default {
    ...
    methods: {
      async creaDocumento(){
        ...
        this.generateQR('https://bit.ly/3UVXwlO');
        let data = "";
          ...
          setTimeout(async function(){
            ...
            const report = await createReport({
              template,
              data: { folio: '517-2022', cliente: 'Elyar Alberto López Dávila', domicilio:'Conocido SN', localidad:'Huatusco, Ver.', fecha:'14-12-2022 al 14-01-2023', tratamiento:'SE REALIZÓ TRATAMIENTO CORRECTIVO Y PREVENTIVO PARA PLAGAS RASTRERAS Y VOLADORAS. SE APLICÓ ALFACIPERMETRINA+FLUFENOXURON. REGISTRO COFEPRIS DE PRODUCTO: RSCO-URB-MEZC-1102-0435-64-5.88', areas:'PISOS, PAREDES, BAÑOS Y PERIMETRO', short_url:'' },
              additionalJsContext: {
                qr: url => {
